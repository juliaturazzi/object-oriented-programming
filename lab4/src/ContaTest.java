...
public class ContaTest {
    ...
    private Conta contaDaMaria = new Conta(2, maria);
    ...
    public void testJuros(){
        Correntista Julia = new Correntista("Julia", 121);
        Conta contaJulia = new Conta(501, Julia);

        ContaInvestimento contaInvestimentoJulia = new ContaInvestimento(95, Julia,"Ethereum", 1.75f);
        contaJulia.receberDepositoEmDinheiro(70000);
        contaJulia.efetuarTransferecia(contaInvestimentoJulia, 70000);
        contaInvestimentoJulia.aplicarJuros();

        assertEquals("SALDO = 122517.5",122517.5, contaInvestimentoJulia.getSaldoEmReais(), FLOAT_DELTA);
    }

    @Test
    public void testResgatarSaldo() {
        Correntista Julia = new Correntista("Julia", 121);
        Conta contaJulia = new Conta(501, Julia);
        ...
        contaJulia.receberDepositoEmDinheiro(70000);
        contaJulia.efetuarTransferecia(contaInvestimentoJulia, 70000);
        contaInvestimentoJulia.resgatarTotal(contaJulia);

        assertEquals("SALDO = 0", 0, contaInvestimentoJulia.getSaldoEmReais(), FLOAT_DELTA);
    }
