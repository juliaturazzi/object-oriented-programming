...
public class Jogador {
    ...
    public Jogador(String username) { this(username, SENHA_PADRAO); }
    ...
    public void adicionarPartidaJogada(Partida partida) {
        ...
        switch (partida.getResultado()) {
            ...
            case Partida.VITORIA_JOGADOR_1:
                if (partida.getJogador1().equals(this))  this.pontuacao += JogoOnline.PONTOS_VITORIA;
                else  this.pontuacao += JogoOnline.PONTOS_DERROTA;

                break;

            case Partida.VITORIA_JOGADOR_2:
                if (partida.getJogador2().equals(this))  this.pontuacao += JogoOnline.PONTOS_VITORIA;
                else  this.pontuacao += JogoOnline.PONTOS_DERROTA;
