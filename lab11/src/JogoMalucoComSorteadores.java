public class JogoMalucoComSorteadores<S1 extends Sorteador<Integer>, S2 extends Sorteador<Integer>>
    ...
    protected Resultado executarRodadaDoJogo() {
        ...
        if (valorSorteadoParaOJogador1 > valorSorteadoParaOJogador2)  return Resultado.VITORIA_JOGADOR_1;
        else if (valorSorteadoParaOJogador1 < valorSorteadoParaOJogador2)  return Resultado.VITORIA_JOGADOR_2;
