...
public abstract class JogoDeDoisJogadores {
    ...
    private class Partida {
        ...
        Resultado getResultado() {
            if (contRodadasVencidasJogador1 > contRodadasVencidasJogador2)  return Resultado.VITORIA_JOGADOR_1;

            else if (contRodadasVencidasJogador1 < contRodadasVencidasJogador2)  return Resultado.VITORIA_JOGADOR_2;
