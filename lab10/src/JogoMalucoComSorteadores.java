public class JogoMalucoComSorteadores <s1 extends Sorteador,s2 extends Sorteador> extends JogoDeDoisJogadores {
    ...
    protected int executarRodadaDoJogo() {
        ...
        if (valorSorteadoParaOJogador1 > valorSorteadoParaOJogador2)  return VITORIA_JOGADOR_1;

        else if (valorSorteadoParaOJogador1 < valorSorteadoParaOJogador2)  return VITORIA_JOGADOR_2;
