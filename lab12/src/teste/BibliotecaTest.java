...
public class BibliotecaTest {
    ...
    public void setUp() {
        cpfUsuario1 = 1111L;
        usuario1 = new Usuario("Julia", cpfUsuario1);
        ...
        biblioteca.incluirLivroNoAcervo(livroRaro, 1);
    ...
    public void testeEmprestarLivroParaUsuarioComMuitosLivrosDevidos()
        ...
        for (int i = 0; i < Biblioteca.MAX_LIVROS_DEVIDOS; i++)  biblioteca.emprestarLivro(livroAbundante, usuario1);
